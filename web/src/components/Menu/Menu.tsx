...
const Menu = () => {
  ...
  return (
    <>
      <div
        id='menu'
        className={`group/menu dark mt-[60px] bg-gray-900 fixed md:inset-y-0 md:flex md:w-[260px] md:flex-col transition-transform z-[999] top-[60px] left-0 h-[calc(100%-60px)] max-md:w-3/4 ${
